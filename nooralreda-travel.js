        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/nooralredatravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        ...
        image_1: ['عروض-شركة-نور-الرضا/عروض-اندونيسيا/عرض-اندونيسيا-1.jpg', 'رحلة شهر عسل - بونشاك & باندونق & جاكرتا'],
        image_2: ['عروض-شركة-نور-الرضا/عروض-اندونيسيا/عرض-اندونيسيا-2.jpg', 'رحلة شهر عسل - بونشاك & بالي & جاكرتا'],
    },

    {
        title: 'عروض المالديف',
        image_1: ['عروض-شركة-نور-الرضا/عروض-المالديف/عرض-المالديف-1.jpg', 'المالديف - منتجع So Maldives'],
        image_2: ['عروض-شركة-نور-الرضا/عروض-المالديف/عرض-المالديف-2.jpg', 'المالديف - منتجع Siyam World'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['عروض-شركة-نور-الرضا/عروض-جورجيا/عرض-جورجيا-1.jpg', 'جورجيا - تبليسي & باكورياني'],
        image_2: ['عروض-شركة-نور-الرضا/عروض-جورجيا/عرض-جورجيا-2.jpg', 'جورجيا - تبليسي'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-نور-الرضا/عروض-تايلاند/عرض-تايلاند-1.jpg', 'تايلاند - بانكوك & باتايا'],
    },

    {
        title: 'عروض فيتنام',
        image_1: ['عروض-شركة-نور-الرضا/عروض-فيتنام/عرض-فيتنام-1.jpg', 'هانوي & هالونج & دانانج & سايجون'],
    },

    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-نور-الرضا/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'سلانجور & لنكاوي & كوالالمبور'],
    },

    {
        title: 'عروض ماليزيا تايلاند',
        image_1: ['عروض-شركة-نور-الرضا/عروض-ماليزيا-تايلاند/عرض-ماليزيا-تايلاند-1.jpg', 'سلانجور & جنتنج هاي لاند & بوكيت & كوالالمبور'],
    },

    {
        title: 'عروض روسيا',
        image_1: ['عروض-شركة-نور-الرضا/عروض-روسيا/عرض-روسيا-1.jpg', 'روسيا - موسكو 7 ايام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966536931460?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/nooralredatravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة نور الرضا على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة نور الرضا على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة نور الرضا على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة نور الرضا للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة نور الرضا للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة نور الرضا`;
            img.title = `مكتب سياحي - شركة نور الرضا`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966536931460";
